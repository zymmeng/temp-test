...
onMounted(()=>{
  chartViewer.value=echarts.init(mychart.value,null, { renderer: "svg", passive: true });
  chartViewer.value.setOption(option );
})
const count = ref(0)
</script>
...
<template>
    ...
    <div>时间</div>  <el-input v-model="time"></el-input>
     <div>温度</div>  <el-input v-model="temperature"></el-input>
